...
const1 = csp.Constraint([name_to_variable_map["sa"], name_to_variable_map["wa"]], csp.all_diff_constraint_evaluator)
const2 = csp.Constraint([name_to_variable_map["sa"], name_to_variable_map["nt"]], csp.all_diff_constraint_evaluator)
const3 = csp.Constraint([name_to_variable_map["sa"], name_to_variable_map["q"]], csp.all_diff_constraint_evaluator)
const4 = csp.Constraint([name_to_variable_map["sa"], name_to_variable_map["nsw"]], csp.all_diff_constraint_evaluator)
const5 = csp.Constraint([name_to_variable_map["sa"], name_to_variable_map["v"]], csp.all_diff_constraint_evaluator)
const6 = csp.Constraint([name_to_variable_map["wa"], name_to_variable_map["nt"]], csp.all_diff_constraint_evaluator)
const7 = csp.Constraint([name_to_variable_map["nt"], name_to_variable_map["q"]], csp.all_diff_constraint_evaluator)
const8 = csp.Constraint([name_to_variable_map["q"], name_to_variable_map["nsw"]], csp.all_diff_constraint_evaluator)
const9 = csp.Constraint([name_to_variable_map["nsw"], name_to_variable_map["v"]], csp.all_diff_constraint_evaluator)
