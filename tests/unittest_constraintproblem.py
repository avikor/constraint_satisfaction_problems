...
class TestConstraintProblem(unittest.TestCase):
    ...
    def setUp(self):
        ...
        const1 = csp.Constraint([variables["sa"], variables["wa"]], csp.all_different)
        const2 = csp.Constraint([variables["sa"], variables["nt"]], csp.all_different)
        const3 = csp.Constraint([variables["sa"], variables["q"]], csp.all_different)
        const4 = csp.Constraint([variables["sa"], variables["nsw"]], csp.all_different)
        const5 = csp.Constraint([variables["sa"], variables["v"]], csp.all_different)
        const6 = csp.Constraint([variables["wa"], variables["nt"]], csp.all_different)
        const7 = csp.Constraint([variables["nt"], variables["q"]], csp.all_different)
        const8 = csp.Constraint([variables["q"], variables["nsw"]], csp.all_different)
        const9 = csp.Constraint([variables["nsw"], variables["v"]], csp.all_different)
